<template>
  <el-form ref="genInfoForm" :model="info" :rules="rules" label-width="150px">
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="packageName">
          <span slot="label">
            Package Path
            <el-tooltip content="Java package to generate into, e.g. com.ruoyi.system" placement="top">
      ...
      <el-col :span="12">
        <el-form-item prop="genType">
          <span slot="label">
            ...
            <el-tooltip content="Default is zip package download, or custom path" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
      ...
      <el-col :span="24" v-if="info.genType == '1'">
        <el-form-item prop="genPath">
          <span slot="label">
            Custom Path
            <el-tooltip content="Enter absolute disk path, if not filled, generate to current Web project" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
          <el-input v-model="info.genPath">
            <el-dropdown slot="append">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="info.genPath = '/'">Restore default base path</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </el-input>
        </el-form-item>
    ...
    <el-row v-show="info.tplCategory == 'sub'">
      <h4 class="form-header">Relationship Information</h4>
      <el-col :span="12">
        <el-form-item>
          <span slot="label">
            Related Sub-table Name
            <el-tooltip content="Name of related sub-table, e.g.: sys_user" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
      ...
      <el-col :span="12">
        <el-form-item>
          <span slot="label">
            ...
            <el-tooltip content="Name of sub-table foreign key, e.g.: user_id" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
...
export default {
  ...
  methods: {
    ...
    /** Triggered when selecting sub-table name */
    subSelectChange(value) {
      this.info.subTableFkName = '';
    },
    /** Triggered when selecting generation template */
