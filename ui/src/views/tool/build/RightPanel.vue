      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.placeholder!==undefined" label="Placeholder">
            <el-input v-model="activeData.placeholder" placeholder="Please enter placeholder text" />
          </el-form-item>
          <el-form-item v-if="activeData['start-placeholder']!==undefined" label="Start Placeholder">
            <el-input v-model="activeData['start-placeholder']" placeholder="Please enter placeholder text" />
          </el-form-item>
          <el-form-item v-if="activeData['end-placeholder']!==undefined" label="End Placeholder">
            <el-input v-model="activeData['end-placeholder']" placeholder="Please enter placeholder text" />
          </el-form-item>
          <el-form-item v-if="activeData.span!==undefined" label="Form Grid">
            <el-slider v-model="activeData.span" :max="24" :min="1" :marks="{12:''}" @change="spanChange" />
          </el-form-item>
          <el-form-item v-if="activeData.layout==='rowFormItem'" label="Grid Gutter">
            <el-input-number v-model="activeData.gutter" :min="0" placeholder="Grid gutter" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.format !== undefined" label="Date Format">
            <el-input
              :value="activeData.format"
              placeholder="Please enter date format"
          ...
          <el-form-item v-if="activeData['show-word-limit'] !== undefined" label="Input Counter">
          ...
          <template v-if="activeData.layout === 'colFormItem'">
            ...
            >
              ...
              <el-form-item label="Pattern">
                <el-input v-model="item.pattern" placeholder="Please enter regular expression" />
              </el-form-item>
        ...
        <el-form v-show="currentTab === 'form'" size="small" label-width="90px">
          ...
          <el-form-item label="Grid Gutter">
            <el-input-number v-model="formConf.gutter" :min="0" placeholder="Grid gutter" />
          </el-form-item>
          ...
          <el-form-item label="Show Unfocused Borders">
...
export default {
  ...
  methods: {
    ...
    colorFormatChange(val) {
      ...
      this.activeData.renderKey = +new Date() // Update renderKey to re-render the component
    },
