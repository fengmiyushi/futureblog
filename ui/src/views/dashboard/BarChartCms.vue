<template>
  <div :class="className" :style="{height:height,width:width}" >
    <h3 class="title">Essays Total: {{total}}</h3>
  ...
  methods: {
    ...
    initChart() {
      ...
      this.chart.setOption({
        tooltip: {
          trigger: 'axis',
          axisPointer: { // Coordinate axis indicator, effective when triggered by coordinate axis
            type: 'shadow' // Default is line, optional: 'line' | 'shadow'
          }
        },
        grid: {
          top: 10,
