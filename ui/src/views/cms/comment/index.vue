  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="Article Title" prop="blogTitle">
        <el-input v-model="queryParams.blogTitle" placeholder="Please enter article title" clearable size="small"
                  @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
          ...
          <div class="content">
            <div style="display: flex;justify-content: space-between;width: 100%">
              <div class="nkname">
                ...
                <span v-show="mes.type=='0'" class="rp">commented on your post</span>
