      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="Content">
          ...
          <el-row style="margin-bottom: 20px;">
            <el-col align="right">
              <span v-show="form.contentType ==='2'" style="color: #E6A23C;margin-right: 20px;">Markdown editor content will overwrite other rich text editor content after saving</span>
              Editor:
...
export default {
  ...
  methods: {
    ...
    saveForm() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          this.$modal.confirm('Are you sure you want to save as draft?').then(()=>{
            this.form.type = 2;
            this.form.status = 0;
            if (this.top) {
              this.form.top = 1;
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you sure you want to delete the blog with ID "' + ids + '"?').then(function() {
