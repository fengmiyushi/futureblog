      ...
      <el-card style="background-color: rgba(255, 255, 255,1)" class="first-card">
        ...
        <!-- <div class="appreciate">
          <el-popover
            ...
            <el-button class="donate" slot="reference" type="danger" round plain>Donate</el-button>
          </el-popover>
        </div> -->
        <el-table :data="blog.blogFilesNew" :border="true" style="width: 99.99%;">
          <el-table-column align="center" min-width="30%" prop="remark" label="Attachments">
          ...
          <el-table-column align="center" min-width="50%" prop="remark" label="Description">
            <template slot-scope="scope">
          ...
          <el-table-column align="center" min-width="20%" label="Actions">
            <template slot-scope="scope">
              ...
              <el-button size="mini" plain @click="handlePreview(scope.row)">Preview</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="author">
          <ul>
            ...
            <li>Published: {{blog.createTime}}</li>
          </ul>
        </div>
