...
export default {
  ...
  data() {
    return {
      ...
      title: "Edit Avatar",
      options: {
        img: store.getters.avatar, // Address of the image to be cropped
        autoCrop: true, // Whether to generate a crop box by default
  ...
  methods: {
    ...
    beforeUpload(file) {
      if (file.type.indexOf("image/") == -1) {
        this.$modal.msgError("File format error, please upload image files such as JPG, PNG.");
      } else {
